...
def createLabelImage(annotation, encoding, outline=None, dataset_name="Cityscapes"):

    if dataset_name == "Cityscapes":
        #print("\n Using Cityscapes dataset")
        from labels import name2label
    elif dataset_name == "LostAndFound":
        #print("\n Using LostAndFound dataset")
        from labels import laf_name2label as name2label
...
def json2labelImg(inJson,outImg,encoding="ids", dataset_name="Cityscapes"):
    annotation = Annotation()
    annotation.fromJsonFile(inJson)
    labelImg   = createLabelImage( annotation , encoding, dataset_name=dataset_name)
