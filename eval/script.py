...
from performance import count_active_parameters, count_flops, count_params, get_model_size
from state_dictionary import load_my_quant_fx_state_dict, load_my_state_dict
import torch
...
TEMPERATURES = [0, 0.5, 0.75, 1.1, 2.15]
...
PERFORMANCE = 1
# numero di split in cui dividere il dataset per la valutazione (solo il primo viene utilizzato)
SPLIT = 10
...
DatasetDir = {
    ...
    "RoadObstacle21": "./Dataset/Validation_Dataset/RoadObstacle21/images/*.webp",
              }
...
def main():
    ...
    for QUANT, PRUNED in [(0,0), (0,1), (1,0), (1,1)]:
        ...
        if PERFORMANCE:
            ...
            file = open('results.txt', 'a')
            #file.write("Number of parameters: " + str(total_params) + "\n")
            #file.write("Number of active parameters: " + str(active_params) + "\n")
